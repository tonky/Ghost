...
CACHE_URL="${1:-https://847959617b8d3ada9eb84238a37f56ec.r2.cloudflarestorage.com/gleam-enve-cache}"
...
echo "⚡ Uploading packages in parallel (concurrency: 12)..."
printf "%s\n" "${STORE_PATHS[@]}" | xargs -n 1 -P 12 -I {} bash -c 'push_one "$@"' _ {}
